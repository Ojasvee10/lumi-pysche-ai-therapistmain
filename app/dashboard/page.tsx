...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
      <div className="bg-white shadow-sm border-b border-orange-100 px-6 py-4">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-6">
            <Link href="/" className="font-pacifico text-xl text-rose-600">
              LUMIPSYCHE
            </Link>
            <nav className="flex space-x-6">
              <Link href="/chat" className="text-gray-600 hover:text-rose-600 transition-colors">
                Chat
              </Link>
              <Link href="/dashboard" className="text-rose-600 font-medium">
                Dashboard
              </Link>
              <Link href="/exercises" className="text-gray-600 hover:text-rose-600 transition-colors">
                Exercises
              </Link>
            </nav>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track your mood and see your progress over time.</p>
        </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-orange-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-rose-600">{averageMood}/10</p>
              </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-orange-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-rose-600">78%</p>
              </div>
              <i className="ri-trophy-line text-2xl text-rose-600"></i>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-blue-800 text-sm leading-relaxed">
                  "Your mood has been steadily improving over the past week. Keep up the great work with your daily
                  check-ins and therapy sessions!"
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium text-gray-800">
                  {currentMood}/10 - {getMoodLabel(currentMood)}
                </span>
              </div>
              <input
                type="range"
